...
{
    // Gaussian blur
    // Mat image  = imread("/home/shreyas/opencv-cpp/blurring of images/sample.jpeg");
    // if(image.empty())
    // {
    ...
    // imwrite("/home/shreyas/opencv-cpp/blurring of images/gaussian_blur.jpeg",blur_image);
    // waitKey(0);
    ...
    // imwrite("/home/shreyas/opencv-cpp/blurring of images/normal_blur.jpeg",blur_image);
    // waitKey(0);
    ...
    // imwrite("/home/shreyas/opencv-cpp/blurring of images/median_blur.jpeg",blur_image);
    // waitKey(0);
    // return 0;
}